...
lm7 = lm(ln_sal94 ~ gender + clin + dept, data = lawsuit)
lm8 = lm(ln_sal94 ~ gender + clin + cert, data = lawsuit)
lm9 = lm(ln_sal94 ~ gender + clin + exper, data = lawsuit)
lm10 = lm(ln_sal94 ~ gender + clin + rank, data = lawsuit)
...
lm11 = lm(ln_sal94 ~ gender + clin + dept + , data = lawsuit)
...
```{r}
lawsuit_ = lawsuit %>% 
  mutate(ln_exper = log(exper))

lm_final_ = lm(ln_sal94 ~ dept + clin + cert + ln_exper + rank * gender, data = lawsuit_)
summary(lm_final_)
