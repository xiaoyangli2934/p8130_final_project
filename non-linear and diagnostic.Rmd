...
summary(reg13_o_)
```
After deleting no.184 observation, several coefficient change. Specifically, coefficient of gender changes a lot (0.129 to 0.098). There might be other potential preditor we didn't take into consideration. 
