...
data_assistant = filter(data, rank == 1)
data_associate = filter(data, rank == 2)
data_full = filter(data, rank == 3)
reg_assistant = lm(ln_salavg ~ gender + dept + clin + cert + exper, data = data_assistant)
summary(reg_assistant)
reg_associate = lm(ln_salavg ~ gender + dept + clin + cert + exper, data = data_associate)
summary(reg_associate)
reg_full = lm(ln_salavg ~ gender + dept + clin + cert + exper, data = data_full)
summary(reg_full)
```
